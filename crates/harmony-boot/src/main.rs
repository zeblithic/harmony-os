...
unsafe extern "C" fn kernel_continue(state: *mut BootState) -> ! {
    ...
    #[cfg(feature = "ring3")]
    {
        ...
        // 5. Build embedded filesystem for dropbear + busybox
        {
            ...
            // SSH public key authentication. Dropbear reads authorized_keys
            // from ~root/.ssh/. The .ssh directory needs mode 0700 (enforced
            // in sys_newfstatat's EmbeddedFs directory stat path).
            efs.add_file(
