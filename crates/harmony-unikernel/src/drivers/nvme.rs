...
// Queue-setup registers (AQA, ASQ, ACQ) are used in later tasks.
#[allow(dead_code)]
...
/// Used when enabling the controller in a later task.
#[allow(dead_code)]
...
// Queue management fields (admin_sq_*, admin_cq_*, next_cid) are populated
// in the queue-setup task and not yet read by any completed method.
#[allow(dead_code)]
...
// read64, write64, and doorbell_offset are used by queue-setup and I/O
// submission tasks that build on this init-only Task 1 skeleton.
#[allow(dead_code)]
