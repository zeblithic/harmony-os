...
//!
//! The Kernel calls guardian methods directly (register_frame, verify_access,
//! etc.) and guardians return [`IntegrityVerdict`]s.

use crate::vm::{PhysAddr, ViolationReason};
